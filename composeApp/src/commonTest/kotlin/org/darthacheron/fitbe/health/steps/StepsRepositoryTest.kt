...
class StepsRepositoryTest {
    ...
    @Test
    fun `getSteps returns empty list when no data exists`() =
        runTest {
    ...
    @Test
    fun `getSteps returns entries within a simple date range`() =
        runTest {
            // --- GIVEN ---
            ...
            val endDate = LocalDate(2025, 10, 16).atStartOfDayIn(germanTimeZone)
    ...
    @Test
    fun `getSteps includes entry exactly at midnight start of range`() =
        runTest {
            // --- GIVEN ---
    ...
    @Test
    fun `getSteps EDGE CASE handles year boundary in German time`() =
        runTest {
            // --- GIVEN ---
    ...
    @Test
    fun `getSteps EDGE CASE handles Daylight Saving Time change`() =
        runTest {
    ...
    @Test
    fun `getSteps does not include entry at last nanosecond of previous day`() =
        runTest {
            // --- GIVEN ---
    ...
    @Test
    fun `getSteps includes entry at last nanosecond of the day`() =
        runTest {
            // --- GIVEN ---
