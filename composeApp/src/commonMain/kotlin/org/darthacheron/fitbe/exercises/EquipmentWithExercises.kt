...
data class EquipmentWithExercises( // Reusing the name from one-to-many, but the @Relation is different
    ...
    @Relation(
        ...
        associateBy = Junction(
            ...
            parentColumn = "equipment_id", // Column in ExerciseEquipmentCrossRef matching TrainingEquipmentEntity's id
            entityColumn = "exercise_id"   // Column in ExerciseEquipmentCrossRef matching ExerciseEntity's id
        )
    )
