...
object DefaultEquipmentResProvider {
    ...
    val equipmentImageMap: Map<String, DrawableResource?> = mapOf(
        "ic_default_training_equipment_barbell" to Res.drawable.ic_default_training_equipment_barbell,
        "ic_default_training_equipment_dumbbell" to Res.drawable.ic_default_training_equipment_dumbbell,
        "ic_default_training_equipment_bodyweight" to Res.drawable.ic_default_training_equipment_bodyweight,
        "ic_default_training_equipment_kettlebell" to Res.drawable.ic_default_training_equipment_kettlebell,
        "ic_default_training_equipment_dip_station" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_dip_station,
        "ic_default_training_equipment_bench" to Res.drawable.ic_default_training_equipment_bench,
        "ic_default_training_equipment_rowing_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_rowing_machine,
        "ic_default_training_equipment_chest_press_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_chest_press_machine,
        "ic_default_training_equipment_ez_curl_bar" to Res.drawable.ic_default_training_equipment_ez_curl_bar,
        "ic_default_training_equipment_weight_plates" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_weight_plates,
        "ic_default_training_equipment_ankle_weights" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_ankle_weights,
        "ic_default_training_equipment_wrist_weights" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_wrist_weights,
        "ic_default_training_equipment_cable_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_cable_machine,
        "ic_default_training_equipment_lat_pulldown_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_lat_pulldown_machine,
        "ic_default_training_equipment_leg_press_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_leg_press_machine,
        "ic_default_training_equipment_leg_extension_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_leg_extension_machine,
        "ic_default_training_equipment_leg_curl_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_leg_curl_machine,
        "ic_default_training_equipment_smith_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_smith_machine,
        "ic_default_training_equipment_shoulder_press_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_shoulder_press_machine,
        "ic_default_training_equipment_seated_row_machine" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_seated_row_machine,
        "ic_default_training_equipment_pull_up_bar" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_pull_up_bar,
        "ic_default_training_equipment_dip_bars" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_dip_bars,
        "ic_default_training_equipment_push_up_handles" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_push_up_handles,
        "ic_default_training_equipment_parallettes" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_parallettes,
        "ic_default_training_equipment_gymnastic_rings" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_gymnastic_rings,
        "ic_default_training_equipment_suspension_trainer" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_suspension_trainer,
        "ic_default_training_equipment_plyo_box" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_plyo_box,
        "ic_default_training_equipment_medicine_ball" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_medicine_ball,
        "ic_default_training_equipment_slam_ball" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_slam_ball,
        "ic_default_training_equipment_wall_ball" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_wall_ball,
        "ic_default_training_equipment_battle_ropes" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_battle_ropes,
        "ic_default_training_equipment_sandbag" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_sandbag,
        "ic_default_training_equipment_bulgarian_bag" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_bulgarian_bag,
        "ic_default_training_equipment_resistance_bands" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_resistance_bands,
        "ic_default_training_equipment_foam_roller" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_foam_roller,
        "ic_default_training_equipment_balance_pad" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_balance_pad,
        "ic_default_training_equipment_bosu_ball" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_bosu_ball,
        "ic_default_training_equipment_treadmill" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_treadmill,
        "ic_default_training_equipment_elliptical_trainer" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_elliptical_trainer,
        "ic_default_training_equipment_stationary_bike" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_stationary_bike,
        "ic_default_training_equipment_stair_climber" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_stair_climber,
        "ic_default_training_equipment_air_bike" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_air_bike,
        "ic_default_training_equipment_power_rack" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_power_rack,
        "ic_default_training_equipment_squat_rack" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_squat_rack,
        "ic_default_training_equipment_spotter_arms" to Res.drawable.ic_launcher, // Res.drawable.ic_default_training_equipment_spotter_arms
    )
}