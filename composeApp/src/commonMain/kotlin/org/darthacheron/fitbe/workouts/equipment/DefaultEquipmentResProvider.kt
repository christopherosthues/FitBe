...
object DefaultEquipmentResProvider {
    ...
    val equipmentImageMap: Map<String, DrawableResource?> =
        mapOf(
            "default_training_equipment_air_bike" to Res.drawable.ic_launcher,
            "default_training_equipment_ankle_weights" to Res.drawable.ic_launcher,
            "default_training_equipment_balance_pad" to Res.drawable.ic_launcher,
            "default_training_equipment_barbell" to Res.drawable.ic_default_training_equipment_barbell,
            "default_training_equipment_battle_ropes" to Res.drawable.ic_launcher,
            ...
            "default_training_equipment_bosu_ball" to Res.drawable.ic_launcher,
            "default_training_equipment_bulgarian_bag" to Res.drawable.ic_launcher,
            "default_training_equipment_cable_machine" to Res.drawable.ic_launcher,
            "default_training_equipment_chest_press_machine" to Res.drawable.ic_launcher,
            "default_training_equipment_dip_bars" to Res.drawable.ic_launcher,
            "default_training_equipment_dip_station" to Res.drawable.ic_launcher,
            "default_training_equipment_dumbbell" to Res.drawable.ic_default_training_equipment_dumbbell,
            "default_training_equipment_elliptical_trainer" to Res.drawable.ic_launcher,
            "default_training_equipment_ez_curl_bar" to Res.drawable.ic_default_training_equipment_ez_curl_bar,
            "default_training_equipment_foam_roller" to Res.drawable.ic_launcher,
            "default_training_equipment_gymnastic_rings" to Res.drawable.ic_launcher,
            "default_training_equipment_kettlebell" to Res.drawable.ic_default_training_equipment_kettlebell,
            "default_training_equipment_lat_pulldown_machine" to Res.drawable.ic_launcher,
            "default_training_equipment_leg_curl_machine" to Res.drawable.ic_launcher,
            "default_training_equipment_leg_extension_machine" to Res.drawable.ic_launcher,
            "default_training_equipment_leg_press_machine" to Res.drawable.ic_launcher,
            "default_training_equipment_medicine_ball" to Res.drawable.ic_default_training_equipment_medicine_ball,
            "default_training_equipment_parallettes" to Res.drawable.ic_launcher,
            "default_training_equipment_plyo_box" to Res.drawable.ic_launcher,
            ...
            "default_training_equipment_push_up_handles" to Res.drawable.ic_launcher,
            "default_training_equipment_resistance_bands" to Res.drawable.ic_launcher,
            ...
            "default_training_equipment_shoulder_press_machine" to Res.drawable.ic_launcher,
            "default_training_equipment_slam_ball" to Res.drawable.ic_launcher,
            "default_training_equipment_smith_machine" to Res.drawable.ic_launcher,
            "default_training_equipment_spotter_arms" to Res.drawable.ic_launcher,
            "default_training_equipment_squat_rack" to Res.drawable.ic_default_training_equipment_squat_rack,
            "default_training_equipment_stair_climber" to Res.drawable.ic_launcher,
            "default_training_equipment_stationary_bike" to Res.drawable.ic_launcher,
            "default_training_equipment_suspension_trainer" to Res.drawable.ic_launcher,
            "default_training_equipment_treadmill" to Res.drawable.ic_default_training_equipment_treadmill,
            "default_training_equipment_wall_ball" to Res.drawable.ic_launcher,
            "default_training_equipment_weight_plates" to Res.drawable.ic_default_training_equipment_weight_plates,
            "default_training_equipment_wrist_weights" to Res.drawable.ic_launcher,
            ...
            "default_training_equipment_back_extension_machine" to Res.drawable.ic_launcher
        )
}